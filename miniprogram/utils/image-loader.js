...
const { cacheImage, getCachedImagePath, invalidateCachedImage } = require('./image-cache.js')
...
function getNextRetryState(imageState = {}) {
  if (imageState.displayUrl && typeof wx !== 'undefined' && wx.env && imageState.displayUrl.startsWith(`${wx.env.USER_DATA_PATH}/`)) {
    invalidateCachedImage(imageState)
  }
